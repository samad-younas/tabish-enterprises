...
<img class="direct-chat-img" src="{{url('/')}}/theme/dist/img/user1-128x128.jpg" alt="message user image">
...
<img class="direct-chat-img" src="{{url('/')}}/theme/dist/img/user3-128x128.jpg" alt="message user image">
...
<li>
<a href="#">
<img class="contacts-list-img" src="{{url('/')}}/theme/dist/img/user1-128x128.jpg" alt="User Avatar">
...
<li>
<a href="#">
<img class="contacts-list-img" src="{{url('/')}}/theme/dist/img/user7-128x128.jpg" alt="User Avatar">
<div class="contacts-list-info">
<span class="contacts-list-name">
Sarah Doe
...
<li>
<a href="#">
<img class="contacts-list-img" src="{{url('/')}}/theme/dist/img/user3-128x128.jpg" alt="User Avatar">
<div class="contacts-list-info">
<span class="contacts-list-name">
Nadia Jolie
...
<li>
<a href="#">
<img class="contacts-list-img" src="{{url('/')}}/theme/dist/img/user5-128x128.jpg" alt="User Avatar">
<div class="contacts-list-info">
<span class="contacts-list-name">
Nora S. Vans
...
<li>
<a href="#">
<img class="contacts-list-img" src="{{url('/')}}/theme/dist/img/user6-128x128.jpg" alt="User Avatar">
<div class="contacts-list-info">
<span class="contacts-list-name">
John K.
...
<li>
<a href="#">
<img class="contacts-list-img" src="{{url('/')}}/theme/dist/img/user8-128x128.jpg" alt="User Avatar">
<div class="contacts-list-info">
<span class="contacts-list-name">
Kenneth M.
