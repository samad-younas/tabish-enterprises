        ...
        <form>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" v-model="record.currency" @change="changeCurrency()"
                ...
                <div class="form-group">
                    ...
                    <input type="number" v-model="record.amount" @input="calculateAmount()" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input type="number" v-model="record.sale_price" disabled class="form-control"
                        id="exampleInputPassword1" placeholder="sale_price">
                    <small>
            ...
            <div class="card-footer">
                <button @click.prevent="submit()" type="submit" class="btn btn-primary">Sale</button>
            </div>
        </form>
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">All Your Sales are listed Below</h3>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                ...
                                <tbody>
                                    <tr class="odd" v-for="(sale, index) in sales" :key="index">
                                        ...
                                        <td>{{sale.total}}</td>
                                        <td><a @click="editSale(sale)"><i class="nav-icon fas fa-edit" style="color:blue"></i></a> <a
                                                @click="deleteSale(sale.id)"><i class="nav-icon fas fa-trash" style="color: red;"></i></a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                axios.post('/save-udpate-sale', this.record)
                    .then((res) => {
            ...
            generateInvoice(){
                ...
                mywindow.document.write(
                    ...
                    this.record.name +'<br>'+this.record.cnic+'</td><td style="border:1px solid;border-radius: 15px;">Sale</td><td style="text-align:right"><br>Date: ' + this.currentDate +'</td></tr></table></div>')
                mywindow.document.write(
